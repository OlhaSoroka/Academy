...
.btn {
  @apply flex justify-center min-h-[40px] w-full p-2 px-4 text-white font-semibold rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75;
}
.btn_green {
