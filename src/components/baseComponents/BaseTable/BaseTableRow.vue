...
<script lang="ts">
import BaseEditIcon from "../BaseIcons/BaseEditIcon.vue";
import BaseDeleteIcon from "../BaseIcons/BaseDeleteIcon.vue";
import BaseDetailsIcon from "../BaseIcons/BaseDetailsIcon.vue";
export default {
  components: {
    BaseEditIcon,
    BaseDeleteIcon,
