...
.base-input {
  @apply relative block w-full max-w-md rounded-sm border-2  border-stone-400 p-1 font-mono text-base placeholder:text-slate-400 hover:bg-stone-50 focus:border-stone-500 focus:bg-stone-50 focus:outline-none focus:drop-shadow-md;
}
